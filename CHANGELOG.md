...
## [0.14.0] - 2025-04-04
### Added
- Приложение адаптировано для запуска нескольких экземпляров

## [0.15.0] - 2025-04-08
### Added
- Добавлен бот, который откликается на команду /start

## [0.16.0] - 2025-04-16
### Added
- Добавлены уведомления организатору через бот всех событий
- Добавлены уведомления участнику при переходе из резерва в основной список через бот

## [0.17.0] - 2025-04-21
### Added
- добавлена возможность редактировать событие